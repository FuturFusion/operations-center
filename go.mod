...
require (
	...
	github.com/FuturFusion/migration-manager v0.6.12 // indirect
...
require (
	...
	github.com/lxc/incus-os/incus-osd v0.0.0-20260602044547-46c871cdc95e
	github.com/lxc/incus/v7 v7.1.1-0.20260602042211-92cac933412a
