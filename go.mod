...
require (
	...
	github.com/FuturFusion/migration-manager v0.0.0-20250922152727-547f2347c7fd // indirect
...
require (
	...
	github.com/lxc/incus-os/incus-osd v0.0.0-20250927003645-3b3b654c8d1a
