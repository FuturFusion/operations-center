...
func ToExprApiNetworkPeer(n api.NetworkPeer) ExprApiNetworkPeer {
	return ExprApiNetworkPeer{ExprApiNetworkPeerPut: ToExprApiNetworkPeerPut(n.NetworkPeerPut), Name: n.Name, TargetProject: n.TargetProject, TargetNetwork: n.TargetNetwork, Status: n.Status, UsedBy: n.UsedBy, Type: n.Type, TargetIntegration: n.TargetIntegration}
}
func ToExprApiNetworkPeerPut(n api.NetworkPeerPut) ExprApiNetworkPeerPut {
	return ExprApiNetworkPeerPut{Description: n.Description, Config: n.Config}
}
func ToExprNetworkPeer(n NetworkPeer) ExprNetworkPeer {
	return ExprNetworkPeer{ID: n.ID, UUID: n.UUID, Cluster: n.Cluster, NetworkName: n.NetworkName, Name: n.Name, Object: ToExprApiNetworkPeer(n.Object), LastUpdated: n.LastUpdated}
}
