...
func ToExprApiNetworkAddressSet(n api.NetworkAddressSet) ExprApiNetworkAddressSet {
	return ExprApiNetworkAddressSet{ExprApiNetworkAddressSetPut: ToExprApiNetworkAddressSetPut(n.NetworkAddressSetPut), ExprApiNetworkAddressSetPost: ToExprApiNetworkAddressSetPost(n.NetworkAddressSetPost), UsedBy: n.UsedBy, Project: n.Project}
}
func ToExprApiNetworkAddressSetPost(n api.NetworkAddressSetPost) ExprApiNetworkAddressSetPost {
	return ExprApiNetworkAddressSetPost{Name: n.Name}
}
func ToExprApiNetworkAddressSetPut(n api.NetworkAddressSetPut) ExprApiNetworkAddressSetPut {
	return ExprApiNetworkAddressSetPut{Addresses: n.Addresses, Config: n.Config, Description: n.Description}
}
func ToExprNetworkAddressSet(n NetworkAddressSet) ExprNetworkAddressSet {
	return ExprNetworkAddressSet{ID: n.ID, UUID: n.UUID, Cluster: n.Cluster, ProjectName: n.ProjectName, Name: n.Name, Object: ToExprApiNetworkAddressSet(n.Object), LastUpdated: n.LastUpdated}
}
