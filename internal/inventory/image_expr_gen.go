...
func ToExprApiImage(i api.Image) ExprApiImage {
	return ExprApiImage{ExprApiImagePut: ToExprApiImagePut(i.ImagePut), Aliases: sliceConvert(i.Aliases, ToExprApiImageAlias), Architecture: i.Architecture, Cached: i.Cached, Filename: i.Filename, Fingerprint: i.Fingerprint, Size: i.Size, UpdateSource: toPtr(ToExprApiImageSource(fromPtr(i.UpdateSource))), Type: i.Type, CreatedAt: i.CreatedAt, LastUsedAt: i.LastUsedAt, UploadedAt: i.UploadedAt, Project: i.Project}
}
func ToExprApiImageAlias(i api.ImageAlias) ExprApiImageAlias {
	return ExprApiImageAlias{Name: i.Name, Description: i.Description}
}
func ToExprApiImagePut(i api.ImagePut) ExprApiImagePut {
	return ExprApiImagePut{AutoUpdate: i.AutoUpdate, Properties: i.Properties, Public: i.Public, ExpiresAt: i.ExpiresAt, Profiles: i.Profiles}
}
func ToExprApiImageSource(i api.ImageSource) ExprApiImageSource {
	return ExprApiImageSource{Alias: i.Alias, Certificate: i.Certificate, Protocol: i.Protocol, Server: i.Server, ImageType: i.ImageType}
}
func ToExprImage(i Image) ExprImage {
	return ExprImage{ID: i.ID, UUID: i.UUID, Cluster: i.Cluster, ProjectName: i.ProjectName, Name: i.Name, Object: ToExprApiImage(i.Object), LastUpdated: i.LastUpdated}
}
