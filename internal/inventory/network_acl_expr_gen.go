...
func ToExprApiNetworkACL(n api.NetworkACL) ExprApiNetworkACL {
	return ExprApiNetworkACL{ExprApiNetworkACLPost: ToExprApiNetworkACLPost(n.NetworkACLPost), ExprApiNetworkACLPut: ToExprApiNetworkACLPut(n.NetworkACLPut), UsedBy: n.UsedBy, Project: n.Project}
}
func ToExprApiNetworkACLPost(n api.NetworkACLPost) ExprApiNetworkACLPost {
	return ExprApiNetworkACLPost{Name: n.Name}
}
func ToExprApiNetworkACLPut(n api.NetworkACLPut) ExprApiNetworkACLPut {
	return ExprApiNetworkACLPut{Description: n.Description, Egress: sliceConvert(n.Egress, ToExprApiNetworkACLRule), Ingress: sliceConvert(n.Ingress, ToExprApiNetworkACLRule), Config: n.Config}
}
func ToExprApiNetworkACLRule(n api.NetworkACLRule) ExprApiNetworkACLRule {
	return ExprApiNetworkACLRule{Action: n.Action, Source: n.Source, Destination: n.Destination, Protocol: n.Protocol, SourcePort: n.SourcePort, DestinationPort: n.DestinationPort, ICMPType: n.ICMPType, ICMPCode: n.ICMPCode, Description: n.Description, State: n.State}
}
func ToExprNetworkACL(n NetworkACL) ExprNetworkACL {
	return ExprNetworkACL{ID: n.ID, UUID: n.UUID, Cluster: n.Cluster, ProjectName: n.ProjectName, Name: n.Name, Object: ToExprApiNetworkACL(n.Object), LastUpdated: n.LastUpdated}
}
