...
func (_d NetworkLoadBalancerServerClientWithPrometheus) GetNetworkLoadBalancerByName(ctx context.Context, connectionURL string, networkName string, networkLoadBalancerName string) (networkLoadBalancer api.NetworkLoadBalancer, err error) {
	_since := time.Now()
	defer func() {
		result := "ok"
		if err != nil {
...
func (_d NetworkLoadBalancerServerClientWithPrometheus) GetNetworkLoadBalancers(ctx context.Context, connectionURL string, networkName string) (networkLoadBalancers []api.NetworkLoadBalancer, err error) {
	_since := time.Now()
	defer func() {
		result := "ok"
		if err != nil {
