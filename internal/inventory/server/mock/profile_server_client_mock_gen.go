...
func (mock *ProfileServerClientMock) GetProfileByName(ctx context.Context, endpoint provisioning.Endpoint, projectName string, profileName string) (api.Profile, error) {
