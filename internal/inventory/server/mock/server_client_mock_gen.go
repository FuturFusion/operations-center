...
func (mock *ServerClientMock) GetStorageVolumeByName(ctx context.Context, connectionURL string, storagePoolName string, storageVolumeName string) (api.StorageVolume, error) {
