...
func ToExprApiStoragePool(s api.StoragePool) ExprApiStoragePool {
	return ExprApiStoragePool{ExprApiStoragePoolPut: ToExprApiStoragePoolPut(s.StoragePoolPut), Name: s.Name, Driver: s.Driver, UsedBy: s.UsedBy, Status: s.Status, Locations: s.Locations}
}
func ToExprApiStoragePoolPut(s api.StoragePoolPut) ExprApiStoragePoolPut {
	return ExprApiStoragePoolPut{Config: s.Config, Description: s.Description}
}
func ToExprStoragePool(s StoragePool) ExprStoragePool {
	return ExprStoragePool{ID: s.ID, UUID: s.UUID, Cluster: s.Cluster, Name: s.Name, Object: ToExprApiStoragePool(s.Object), LastUpdated: s.LastUpdated}
}
