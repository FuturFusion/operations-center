...
func ToExprApiNetwork(n api.Network) ExprApiNetwork {
	return ExprApiNetwork{ExprApiNetworkPut: ToExprApiNetworkPut(n.NetworkPut), Name: n.Name, Type: n.Type, UsedBy: n.UsedBy, Managed: n.Managed, Status: n.Status, Locations: n.Locations, Project: n.Project}
}
func ToExprApiNetworkPut(n api.NetworkPut) ExprApiNetworkPut {
	return ExprApiNetworkPut{Config: n.Config, Description: n.Description}
}
func ToExprNetwork(n Network) ExprNetwork {
	return ExprNetwork{ID: n.ID, UUID: n.UUID, Cluster: n.Cluster, ProjectName: n.ProjectName, Name: n.Name, Object: ToExprApiNetwork(n.Object), LastUpdated: n.LastUpdated}
}
