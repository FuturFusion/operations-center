...
SELECT network_forwards.id, network_forwards.uuid, clusters.name AS cluster, network_forwards.network_name, network_forwards.name, network_forwards.object, network_forwards.last_updated
...
func networkForwardColumns() string {
	return "network_forwards.id, network_forwards.uuid, clusters.name AS cluster, network_forwards.network_name, network_forwards.name, network_forwards.object, network_forwards.last_updated"
}
