...
SELECT network_peers.id, network_peers.uuid, clusters.name AS cluster, network_peers.network_name, network_peers.name, network_peers.object, network_peers.last_updated
  FROM network_peers
...
func networkPeerColumns() string {
	return "network_peers.id, network_peers.uuid, clusters.name AS cluster, network_peers.network_name, network_peers.name, network_peers.object, network_peers.last_updated"
}
