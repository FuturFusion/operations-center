...
func (mock *NetworkForwardRepoMock) DeleteByCluster(ctx context.Context, cluster string) error {
	if mock.DeleteByClusterFunc == nil {
		panic("NetworkForwardRepoMock.DeleteByClusterFunc: method is nil but NetworkForwardRepo.DeleteByCluster was just called")
	}
	callInfo := struct {
		Ctx     context.Context
		Cluster string
...
// Check the length with:
//
//	len(mockedNetworkForwardRepo.DeleteByClusterCalls())
func (mock *NetworkForwardRepoMock) DeleteByClusterCalls() []struct {
	Ctx     context.Context
	Cluster string
} {
	var calls []struct {
