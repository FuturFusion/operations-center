...
func (mock *NetworkForwardRepoMock) DeleteByServerID(ctx context.Context, serverID int) error {
	if mock.DeleteByServerIDFunc == nil {
		panic("NetworkForwardRepoMock.DeleteByServerIDFunc: method is nil but NetworkForwardRepo.DeleteByServerID was just called")
	}
	callInfo := struct {
		Ctx      context.Context
		ServerID int
...
// Check the length with:
//
//	len(mockedNetworkForwardRepo.DeleteByServerIDCalls())
func (mock *NetworkForwardRepoMock) DeleteByServerIDCalls() []struct {
	Ctx      context.Context
	ServerID int
} {
	var calls []struct {
