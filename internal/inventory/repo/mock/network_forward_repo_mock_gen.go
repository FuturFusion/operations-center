...
func (mock *NetworkForwardRepoMock) GetAllIDs(ctx context.Context) ([]int, error) {
	if mock.GetAllIDsFunc == nil {
		panic("NetworkForwardRepoMock.GetAllIDsFunc: method is nil but NetworkForwardRepo.GetAllIDs was just called")
	}
	callInfo := struct {
		Ctx context.Context
	}{
...
// Check the length with:
//
//	len(mockedNetworkForwardRepo.GetAllIDsCalls())
func (mock *NetworkForwardRepoMock) GetAllIDsCalls() []struct {
	Ctx context.Context
} {
	var calls []struct {
		Ctx context.Context
