...
func (mock *NetworkIntegrationRepoMock) DeleteByCluster(ctx context.Context, cluster string) error {
	if mock.DeleteByClusterFunc == nil {
		panic("NetworkIntegrationRepoMock.DeleteByClusterFunc: method is nil but NetworkIntegrationRepo.DeleteByCluster was just called")
	}
	callInfo := struct {
		Ctx     context.Context
		Cluster string
...
// Check the length with:
//
//	len(mockedNetworkIntegrationRepo.DeleteByClusterCalls())
func (mock *NetworkIntegrationRepoMock) DeleteByClusterCalls() []struct {
	Ctx     context.Context
	Cluster string
} {
	var calls []struct {
