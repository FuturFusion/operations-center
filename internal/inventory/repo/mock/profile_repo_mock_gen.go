...
func (mock *ProfileRepoMock) DeleteByCluster(ctx context.Context, cluster string) error {
	if mock.DeleteByClusterFunc == nil {
		panic("ProfileRepoMock.DeleteByClusterFunc: method is nil but ProfileRepo.DeleteByCluster was just called")
	}
	callInfo := struct {
		Ctx     context.Context
		Cluster string
...
// Check the length with:
//
//	len(mockedProfileRepo.DeleteByClusterCalls())
func (mock *ProfileRepoMock) DeleteByClusterCalls() []struct {
	Ctx     context.Context
	Cluster string
} {
	var calls []struct {
