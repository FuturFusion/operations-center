...
func (mock *NetworkPeerRepoMock) DeleteByCluster(ctx context.Context, cluster string) error {
	if mock.DeleteByClusterFunc == nil {
		panic("NetworkPeerRepoMock.DeleteByClusterFunc: method is nil but NetworkPeerRepo.DeleteByCluster was just called")
	}
	callInfo := struct {
		Ctx     context.Context
		Cluster string
...
// Check the length with:
//
//	len(mockedNetworkPeerRepo.DeleteByClusterCalls())
func (mock *NetworkPeerRepoMock) DeleteByClusterCalls() []struct {
	Ctx     context.Context
	Cluster string
} {
	var calls []struct {
