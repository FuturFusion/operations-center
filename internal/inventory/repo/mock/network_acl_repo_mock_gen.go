...
func (mock *NetworkACLRepoMock) DeleteByCluster(ctx context.Context, cluster string) error {
	if mock.DeleteByClusterFunc == nil {
		panic("NetworkACLRepoMock.DeleteByClusterFunc: method is nil but NetworkACLRepo.DeleteByCluster was just called")
	}
	callInfo := struct {
		Ctx     context.Context
		Cluster string
...
// Check the length with:
//
//	len(mockedNetworkACLRepo.DeleteByClusterCalls())
func (mock *NetworkACLRepoMock) DeleteByClusterCalls() []struct {
	Ctx     context.Context
	Cluster string
} {
	var calls []struct {
