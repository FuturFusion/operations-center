...
func (mock *NetworkACLRepoMock) DeleteByClusterID(ctx context.Context, clusterID int) error {
	if mock.DeleteByClusterIDFunc == nil {
		panic("NetworkACLRepoMock.DeleteByClusterIDFunc: method is nil but NetworkACLRepo.DeleteByClusterID was just called")
	}
	callInfo := struct {
		Ctx       context.Context
		ClusterID int
...
// Check the length with:
//
//	len(mockedNetworkACLRepo.DeleteByClusterIDCalls())
func (mock *NetworkACLRepoMock) DeleteByClusterIDCalls() []struct {
	Ctx       context.Context
	ClusterID int
} {
	var calls []struct {
