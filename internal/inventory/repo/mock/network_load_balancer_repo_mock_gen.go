...
func (mock *NetworkLoadBalancerRepoMock) GetAllIDs(ctx context.Context) ([]int, error) {
	if mock.GetAllIDsFunc == nil {
		panic("NetworkLoadBalancerRepoMock.GetAllIDsFunc: method is nil but NetworkLoadBalancerRepo.GetAllIDs was just called")
	}
	callInfo := struct {
		Ctx context.Context
	}{
...
// Check the length with:
//
//	len(mockedNetworkLoadBalancerRepo.GetAllIDsCalls())
func (mock *NetworkLoadBalancerRepoMock) GetAllIDsCalls() []struct {
	Ctx context.Context
} {
	var calls []struct {
		Ctx context.Context
