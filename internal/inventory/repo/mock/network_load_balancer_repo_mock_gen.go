...
func (mock *NetworkLoadBalancerRepoMock) DeleteByCluster(ctx context.Context, cluster string) error {
	if mock.DeleteByClusterFunc == nil {
		panic("NetworkLoadBalancerRepoMock.DeleteByClusterFunc: method is nil but NetworkLoadBalancerRepo.DeleteByCluster was just called")
	}
	callInfo := struct {
		Ctx     context.Context
		Cluster string
...
// Check the length with:
//
//	len(mockedNetworkLoadBalancerRepo.DeleteByClusterCalls())
func (mock *NetworkLoadBalancerRepoMock) DeleteByClusterCalls() []struct {
	Ctx     context.Context
	Cluster string
} {
	var calls []struct {
