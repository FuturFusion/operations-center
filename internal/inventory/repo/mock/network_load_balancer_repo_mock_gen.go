...
func (mock *NetworkLoadBalancerRepoMock) DeleteByClusterID(ctx context.Context, clusterID int) error {
	if mock.DeleteByClusterIDFunc == nil {
		panic("NetworkLoadBalancerRepoMock.DeleteByClusterIDFunc: method is nil but NetworkLoadBalancerRepo.DeleteByClusterID was just called")
	}
	callInfo := struct {
		Ctx       context.Context
		ClusterID int
...
// Check the length with:
//
//	len(mockedNetworkLoadBalancerRepo.DeleteByClusterIDCalls())
func (mock *NetworkLoadBalancerRepoMock) DeleteByClusterIDCalls() []struct {
	Ctx       context.Context
	ClusterID int
} {
	var calls []struct {
