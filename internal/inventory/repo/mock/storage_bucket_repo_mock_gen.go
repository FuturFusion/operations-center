...
func (mock *StorageBucketRepoMock) DeleteWithFilter(ctx context.Context, filter inventory.StorageBucketFilter) error {
	if mock.DeleteWithFilterFunc == nil {
		panic("StorageBucketRepoMock.DeleteWithFilterFunc: method is nil but StorageBucketRepo.DeleteWithFilter was just called")
	}
	callInfo := struct {
		Ctx    context.Context
		Filter inventory.StorageBucketFilter
...
// Check the length with:
//
//	len(mockedStorageBucketRepo.DeleteWithFilterCalls())
func (mock *StorageBucketRepoMock) DeleteWithFilterCalls() []struct {
	Ctx    context.Context
	Filter inventory.StorageBucketFilter
} {
	var calls []struct {
