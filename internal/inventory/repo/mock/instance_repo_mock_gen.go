...
func (mock *InstanceRepoMock) DeleteByClusterID(ctx context.Context, clusterID int) error {
	if mock.DeleteByClusterIDFunc == nil {
		panic("InstanceRepoMock.DeleteByClusterIDFunc: method is nil but InstanceRepo.DeleteByClusterID was just called")
	}
	callInfo := struct {
		Ctx       context.Context
		ClusterID int
...
// Check the length with:
//
//	len(mockedInstanceRepo.DeleteByClusterIDCalls())
func (mock *InstanceRepoMock) DeleteByClusterIDCalls() []struct {
	Ctx       context.Context
	ClusterID int
} {
	var calls []struct {
