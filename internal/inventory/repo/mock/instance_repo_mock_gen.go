...
func (mock *InstanceRepoMock) DeleteByServer(ctx context.Context, server string) error {
	if mock.DeleteByServerFunc == nil {
		panic("InstanceRepoMock.DeleteByServerFunc: method is nil but InstanceRepo.DeleteByServer was just called")
	}
	callInfo := struct {
		Ctx    context.Context
		Server string
...
// Check the length with:
//
//	len(mockedInstanceRepo.DeleteByServerCalls())
func (mock *InstanceRepoMock) DeleteByServerCalls() []struct {
	Ctx    context.Context
	Server string
} {
	var calls []struct {
