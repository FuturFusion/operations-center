...
func (mock *StorageVolumeRepoMock) GetAllIDs(ctx context.Context) ([]int, error) {
	if mock.GetAllIDsFunc == nil {
		panic("StorageVolumeRepoMock.GetAllIDsFunc: method is nil but StorageVolumeRepo.GetAllIDs was just called")
	}
	callInfo := struct {
		Ctx context.Context
	}{
...
// Check the length with:
//
//	len(mockedStorageVolumeRepo.GetAllIDsCalls())
func (mock *StorageVolumeRepoMock) GetAllIDsCalls() []struct {
	Ctx context.Context
} {
	var calls []struct {
		Ctx context.Context
