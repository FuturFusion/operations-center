...
func (mock *StorageVolumeRepoMock) DeleteByClusterID(ctx context.Context, clusterID int) error {
	if mock.DeleteByClusterIDFunc == nil {
		panic("StorageVolumeRepoMock.DeleteByClusterIDFunc: method is nil but StorageVolumeRepo.DeleteByClusterID was just called")
	}
	callInfo := struct {
		Ctx       context.Context
		ClusterID int
...
// Check the length with:
//
//	len(mockedStorageVolumeRepo.DeleteByClusterIDCalls())
func (mock *StorageVolumeRepoMock) DeleteByClusterIDCalls() []struct {
	Ctx       context.Context
	ClusterID int
} {
	var calls []struct {
