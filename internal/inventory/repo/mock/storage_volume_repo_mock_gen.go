...
func (mock *StorageVolumeRepoMock) DeleteWithFilter(ctx context.Context, filter inventory.StorageVolumeFilter) error {
	if mock.DeleteWithFilterFunc == nil {
		panic("StorageVolumeRepoMock.DeleteWithFilterFunc: method is nil but StorageVolumeRepo.DeleteWithFilter was just called")
	}
	callInfo := struct {
		Ctx    context.Context
		Filter inventory.StorageVolumeFilter
...
// Check the length with:
//
//	len(mockedStorageVolumeRepo.DeleteWithFilterCalls())
func (mock *StorageVolumeRepoMock) DeleteWithFilterCalls() []struct {
	Ctx    context.Context
	Filter inventory.StorageVolumeFilter
} {
	var calls []struct {
