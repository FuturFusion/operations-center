...
func (mock *ImageRepoMock) DeleteByCluster(ctx context.Context, cluster string) error {
	if mock.DeleteByClusterFunc == nil {
		panic("ImageRepoMock.DeleteByClusterFunc: method is nil but ImageRepo.DeleteByCluster was just called")
	}
	callInfo := struct {
		Ctx     context.Context
		Cluster string
...
// Check the length with:
//
//	len(mockedImageRepo.DeleteByClusterCalls())
func (mock *ImageRepoMock) DeleteByClusterCalls() []struct {
	Ctx     context.Context
	Cluster string
} {
	var calls []struct {
