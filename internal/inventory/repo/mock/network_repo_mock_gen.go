...
func (mock *NetworkRepoMock) GetAllIDs(ctx context.Context) ([]int, error) {
	if mock.GetAllIDsFunc == nil {
		panic("NetworkRepoMock.GetAllIDsFunc: method is nil but NetworkRepo.GetAllIDs was just called")
	}
	callInfo := struct {
		Ctx context.Context
	}{
...
// Check the length with:
//
//	len(mockedNetworkRepo.GetAllIDsCalls())
func (mock *NetworkRepoMock) GetAllIDsCalls() []struct {
	Ctx context.Context
} {
	var calls []struct {
		Ctx context.Context
