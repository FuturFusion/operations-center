...
func (mock *NetworkRepoMock) DeleteByServerID(ctx context.Context, serverID int) error {
	if mock.DeleteByServerIDFunc == nil {
		panic("NetworkRepoMock.DeleteByServerIDFunc: method is nil but NetworkRepo.DeleteByServerID was just called")
	}
	callInfo := struct {
		Ctx      context.Context
		ServerID int
...
// Check the length with:
//
//	len(mockedNetworkRepo.DeleteByServerIDCalls())
func (mock *NetworkRepoMock) DeleteByServerIDCalls() []struct {
	Ctx      context.Context
	ServerID int
} {
	var calls []struct {
