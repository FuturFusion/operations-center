...
type ExprApiInstance struct {
	...
	ExpandedDevices    map[string]map[string]string `json:"expanded_devices,omitempty" yaml:"expanded_devices,omitempty" expr:"expanded_devices"`
...
type ExprApiInstancePut struct {
	...
	Devices      map[string]map[string]string `json:"devices" yaml:"devices" expr:"devices"`
...
func ToExprApiInstance(i api.Instance) ExprApiInstance {
	return ExprApiInstance{ExprApiInstancePut: ToExprApiInstancePut(i.InstancePut), CreatedAt: i.CreatedAt, ExpandedConfig: i.ExpandedConfig, ExpandedDevices: i.ExpandedDevices, Name: i.Name, Status: i.Status, StatusCode: i.StatusCode, LastUsedAt: i.LastUsedAt, Location: i.Location, Type: i.Type, Project: i.Project}
}
func ToExprApiInstanceBackup(i api.InstanceBackup) ExprApiInstanceBackup {
	return ExprApiInstanceBackup{Name: i.Name, CreatedAt: i.CreatedAt, ExpiresAt: i.ExpiresAt, InstanceOnly: i.InstanceOnly, OptimizedStorage: i.OptimizedStorage}
}
func ToExprApiInstanceFull(i api.InstanceFull) ExprApiInstanceFull {
	return ExprApiInstanceFull{ExprApiInstance: ToExprApiInstance(i.Instance), Backups: sliceConvert(i.Backups, ToExprApiInstanceBackup), State: toPtr(ToExprApiInstanceState(fromPtr(i.State))), Snapshots: sliceConvert(i.Snapshots, ToExprApiInstanceSnapshot)}
}
func ToExprApiInstancePut(i api.InstancePut) ExprApiInstancePut {
	return ExprApiInstancePut{Architecture: i.Architecture, Config: i.Config, Devices: i.Devices, Ephemeral: i.Ephemeral, Profiles: i.Profiles, Restore: i.Restore, Stateful: i.Stateful, Description: i.Description}
}
func ToExprApiInstanceSnapshot(i api.InstanceSnapshot) ExprApiInstanceSnapshot {
	return ExprApiInstanceSnapshot{ExprApiInstanceSnapshotPut: ToExprApiInstanceSnapshotPut(i.InstanceSnapshotPut), Architecture: i.Architecture, Config: i.Config, CreatedAt: i.CreatedAt, Description: i.Description, Devices: i.Devices, Ephemeral: i.Ephemeral, ExpandedConfig: i.ExpandedConfig, ExpandedDevices: i.ExpandedDevices, LastUsedAt: i.LastUsedAt, Name: i.Name, Profiles: i.Profiles, Stateful: i.Stateful, Size: i.Size}
}
func ToExprApiInstanceSnapshotPut(i api.InstanceSnapshotPut) ExprApiInstanceSnapshotPut {
	return ExprApiInstanceSnapshotPut{ExpiresAt: i.ExpiresAt}
}
func ToExprApiInstanceState(i api.InstanceState) ExprApiInstanceState {
	return ExprApiInstanceState{Status: i.Status, StatusCode: i.StatusCode, Disk: mapConvert(i.Disk, ToExprApiInstanceStateDisk), Memory: ToExprApiInstanceStateMemory(i.Memory), Network: mapConvert(i.Network, ToExprApiInstanceStateNetwork), Pid: i.Pid, Processes: i.Processes, CPU: ToExprApiInstanceStateCPU(i.CPU), StartedAt: i.StartedAt, OSInfo: toPtr(ToExprApiInstanceStateOSInfo(fromPtr(i.OSInfo)))}
}
func ToExprApiInstanceStateCPU(i api.InstanceStateCPU) ExprApiInstanceStateCPU {
	return ExprApiInstanceStateCPU{Usage: i.Usage, AllocatedTime: i.AllocatedTime}
}
func ToExprApiInstanceStateDisk(i api.InstanceStateDisk) ExprApiInstanceStateDisk {
	return ExprApiInstanceStateDisk{Usage: i.Usage, Total: i.Total}
}
func ToExprApiInstanceStateMemory(i api.InstanceStateMemory) ExprApiInstanceStateMemory {
	return ExprApiInstanceStateMemory{Usage: i.Usage, UsagePeak: i.UsagePeak, Total: i.Total, SwapUsage: i.SwapUsage, SwapUsagePeak: i.SwapUsagePeak}
}
func ToExprApiInstanceStateNetwork(i api.InstanceStateNetwork) ExprApiInstanceStateNetwork {
	return ExprApiInstanceStateNetwork{Addresses: sliceConvert(i.Addresses, ToExprApiInstanceStateNetworkAddress), Counters: ToExprApiInstanceStateNetworkCounters(i.Counters), Hwaddr: i.Hwaddr, HostName: i.HostName, Mtu: i.Mtu, State: i.State, Type: i.Type}
}
func ToExprApiInstanceStateNetworkAddress(i api.InstanceStateNetworkAddress) ExprApiInstanceStateNetworkAddress {
	return ExprApiInstanceStateNetworkAddress{Family: i.Family, Address: i.Address, Netmask: i.Netmask, Scope: i.Scope}
}
func ToExprApiInstanceStateNetworkCounters(i api.InstanceStateNetworkCounters) ExprApiInstanceStateNetworkCounters {
	return ExprApiInstanceStateNetworkCounters{BytesReceived: i.BytesReceived, BytesSent: i.BytesSent, PacketsReceived: i.PacketsReceived, PacketsSent: i.PacketsSent, ErrorsReceived: i.ErrorsReceived, ErrorsSent: i.ErrorsSent, PacketsDroppedOutbound: i.PacketsDroppedOutbound, PacketsDroppedInbound: i.PacketsDroppedInbound}
}
func ToExprApiInstanceStateOSInfo(i api.InstanceStateOSInfo) ExprApiInstanceStateOSInfo {
	return ExprApiInstanceStateOSInfo{OS: i.OS, OSVersion: i.OSVersion, KernelVersion: i.KernelVersion, Hostname: i.Hostname, FQDN: i.FQDN}
}
func ToExprInstance(i Instance) ExprInstance {
	return ExprInstance{ID: i.ID, UUID: i.UUID, Cluster: i.Cluster, Server: i.Server, ProjectName: i.ProjectName, Name: i.Name, Object: ToExprApiInstanceFull(i.Object), LastUpdated: i.LastUpdated}
}
