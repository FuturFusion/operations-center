...
func ToExprApiNetworkIntegration(n api.NetworkIntegration) ExprApiNetworkIntegration {
	return ExprApiNetworkIntegration{ExprApiNetworkIntegrationPut: ToExprApiNetworkIntegrationPut(n.NetworkIntegrationPut), Name: n.Name, Type: n.Type, UsedBy: n.UsedBy}
}
func ToExprApiNetworkIntegrationPut(n api.NetworkIntegrationPut) ExprApiNetworkIntegrationPut {
	return ExprApiNetworkIntegrationPut{Description: n.Description, Config: n.Config}
}
func ToExprNetworkIntegration(n NetworkIntegration) ExprNetworkIntegration {
	return ExprNetworkIntegration{ID: n.ID, UUID: n.UUID, Cluster: n.Cluster, Name: n.Name, Object: ToExprApiNetworkIntegration(n.Object), LastUpdated: n.LastUpdated}
}
