...
func validateAndSave(cfg config) error {
	...
	// FIXME: not the best way to implement singleton for testing.
	if isTesting {
...
func validate(cfg config) error {
	...
	// TODO: updates.signature_verification_root_ca could be PEM decoded in order to verify if it is "likely" valid.

	// TODO: updates.filter_expression and updates.file_filter_expression could be compiled to verify if they are valid.
