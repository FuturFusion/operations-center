...
func (o *Verifier) WriteHeaders(w http.ResponseWriter) error {
	w.Header().Set("X-OperationsCenter-OIDC-issuer", o.issuer)
	w.Header().Set("X-OperationsCenter-OIDC-clientid", o.clientID)
	w.Header().Set("X-OperationsCenter-OIDC-audience", o.audience)
