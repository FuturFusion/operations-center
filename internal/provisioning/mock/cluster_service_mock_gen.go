...
//			},
//			ClusterUpdateControlLoopFunc: func(ctx context.Context) error {
...
func (mock *ClusterServiceMock) ClusterUpdateControlLoop(ctx context.Context) error {
	...
	return mock.ClusterUpdateControlLoopFunc(ctx)
}
