...
type ExprApiBMCData struct {
	...
	VirtualMedia                  []ExprApiBMCVirtualMedia `json:"virtual_media" yaml:"virtual_media" expr:"virtual_media"`
...
func ToExprApiBMCData(b api.BMCData) ExprApiBMCData {
	return ExprApiBMCData{
		...
		VirtualMedia:                  sliceConvert(b.VirtualMedia, ToExprApiBMCVirtualMedia),
