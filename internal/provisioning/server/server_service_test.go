...
func TestServerService_BMCAttachMediaByName(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			wantMediaURL:       "https://192.168.1.200:8443/1.0/provisioning/tokens/" + tokenUUID + "/seeds/default?architecture=x86_64&type=iso",
		...
		},
		{
			...
			wantMediaURL:       "https://192.168.1.200:8443/1.0/provisioning/tokens/" + tokenUUID + "/seeds/default?architecture=aarch64&channel=stable&type=raw",
