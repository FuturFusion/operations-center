...
const boilerplateFixed = `// Code generated by generate-database from the incus project - DO NOT EDIT.
...
func main() {
	err := os.WriteFile("mapper_boilerplate.go", []byte(boilerplateFixed), 0o644)
	if err != nil {
		panic(err)
	}
}
