...
func (f *Flasher) GenerateSeededImage(ctx context.Context, id uuid.UUID, seedConfig provisioning.TokenImageSeeds, file io.ReadCloser) (_ io.ReadCloser, _ error) {
	f.mu.Lock()
