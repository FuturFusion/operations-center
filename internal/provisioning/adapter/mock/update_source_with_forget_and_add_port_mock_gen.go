...
// Ensure that UpdateSourceWithForgetAndAddPortMock does implement provisioning.UpdateSourceWithForgetAndAddPort.
// If this is not the case, regenerate this file with mockery.
var _ provisioning.UpdateSourceWithForgetAndAddPort = &UpdateSourceWithForgetAndAddPortMock{}

// UpdateSourceWithForgetAndAddPortMock is a mock implementation of provisioning.UpdateSourceWithForgetAndAddPort.
//
//	func TestSomethingThatUsesUpdateSourceWithForgetAndAddPort(t *testing.T) {
//
//		// make and configure a mocked provisioning.UpdateSourceWithForgetAndAddPort
//		mockedUpdateSourceWithForgetAndAddPort := &UpdateSourceWithForgetAndAddPortMock{
...
//		}
//
//		// use mockedUpdateSourceWithForgetAndAddPort in code that requires provisioning.UpdateSourceWithForgetAndAddPort
//		// and then make assertions.
//
//	}
type UpdateSourceWithForgetAndAddPortMock struct {
...
// Add calls AddFunc.
func (mock *UpdateSourceWithForgetAndAddPortMock) Add(ctx context.Context, tarReader *tar.Reader) (*provisioning.Update, error) {
	if mock.AddFunc == nil {
		panic("UpdateSourceWithForgetAndAddPortMock.AddFunc: method is nil but UpdateSourceWithForgetAndAddPort.Add was just called")
	}
	callInfo := struct {
		Ctx       context.Context
		TarReader *tar.Reader
...
//
//	len(mockedUpdateSourceWithForgetAndAddPort.AddCalls())
func (mock *UpdateSourceWithForgetAndAddPortMock) AddCalls() []struct {
	Ctx       context.Context
	TarReader *tar.Reader
} {
	var calls []struct {
...
func (mock *UpdateSourceWithForgetAndAddPortMock) ForgetUpdate(ctx context.Context, update provisioning.Update) error {
	if mock.ForgetUpdateFunc == nil {
		panic("UpdateSourceWithForgetAndAddPortMock.ForgetUpdateFunc: method is nil but UpdateSourceWithForgetAndAddPort.ForgetUpdate was just called")
	}
	callInfo := struct {
		Ctx    context.Context
		Update provisioning.Update
...
// Check the length with:
//
//	len(mockedUpdateSourceWithForgetAndAddPort.ForgetUpdateCalls())
func (mock *UpdateSourceWithForgetAndAddPortMock) ForgetUpdateCalls() []struct {
	Ctx    context.Context
	Update provisioning.Update
} {
	var calls []struct {
...
func (mock *UpdateSourceWithForgetAndAddPortMock) GetLatest(ctx context.Context, limit int) (provisioning.Updates, error) {
	if mock.GetLatestFunc == nil {
		panic("UpdateSourceWithForgetAndAddPortMock.GetLatestFunc: method is nil but UpdateSourceWithForgetAndAddPort.GetLatest was just called")
	}
	callInfo := struct {
		Ctx   context.Context
		Limit int
...
// Check the length with:
//
//	len(mockedUpdateSourceWithForgetAndAddPort.GetLatestCalls())
func (mock *UpdateSourceWithForgetAndAddPortMock) GetLatestCalls() []struct {
	Ctx   context.Context
	Limit int
} {
	var calls []struct {
...
func (mock *UpdateSourceWithForgetAndAddPortMock) GetUpdateAllFiles(ctx context.Context, update provisioning.Update) (provisioning.UpdateFiles, error) {
	if mock.GetUpdateAllFilesFunc == nil {
		panic("UpdateSourceWithForgetAndAddPortMock.GetUpdateAllFilesFunc: method is nil but UpdateSourceWithForgetAndAddPort.GetUpdateAllFiles was just called")
	}
	callInfo := struct {
		Ctx    context.Context
		Update provisioning.Update
...
// Check the length with:
//
//	len(mockedUpdateSourceWithForgetAndAddPort.GetUpdateAllFilesCalls())
func (mock *UpdateSourceWithForgetAndAddPortMock) GetUpdateAllFilesCalls() []struct {
	Ctx    context.Context
	Update provisioning.Update
} {
	var calls []struct {
...
func (mock *UpdateSourceWithForgetAndAddPortMock) GetUpdateFileByFilename(ctx context.Context, update provisioning.Update, filename string) (io.ReadCloser, int, error) {
	if mock.GetUpdateFileByFilenameFunc == nil {
		panic("UpdateSourceWithForgetAndAddPortMock.GetUpdateFileByFilenameFunc: method is nil but UpdateSourceWithForgetAndAddPort.GetUpdateFileByFilename was just called")
	}
	callInfo := struct {
		Ctx      context.Context
		Update   provisioning.Update
...
// Check the length with:
//
//	len(mockedUpdateSourceWithForgetAndAddPort.GetUpdateFileByFilenameCalls())
func (mock *UpdateSourceWithForgetAndAddPortMock) GetUpdateFileByFilenameCalls() []struct {
	Ctx      context.Context
	Update   provisioning.Update
	Filename string
} {
