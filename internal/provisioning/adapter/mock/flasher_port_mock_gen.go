...
func (mock *FlasherPortMock) GenerateSeededImage(ctx context.Context, id uuid.UUID, seedConfig provisioning.TokenSeeds, rc io.ReadCloser) (io.ReadCloser, error) {
