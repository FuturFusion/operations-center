...
func (mock *FlasherPortMock) GenerateSeededImage(ctx context.Context, id uuid.UUID, seedConfig provisioning.TokenImageSeeds, rc io.ReadCloser) (io.ReadCloser, error) {
