resource "incus_network" "incusbr0_per_node" {
  ...
  name = "incusbr0"
  # FIXME: description is mutual exclusive with target, needs to be removed for Incus 6.16
  # https://github.com/lxc/terraform-provider-incus/pull/300
  # https://github.com/lxc/incus/pull/2407
