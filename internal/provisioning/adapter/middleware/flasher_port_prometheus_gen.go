...
func (_d FlasherPortWithPrometheus) GenerateSeededImage(ctx context.Context, id uuid.UUID, seedConfig provisioning.TokenImageSeeds, rc io.ReadCloser) (readCloser io.ReadCloser, err error) {
	_since := time.Now()
	defer func() {
		result := "ok"
		if err != nil {
