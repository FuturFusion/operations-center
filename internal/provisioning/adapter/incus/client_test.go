...
func TestClient(t *testing.T) {
  ...
  "metadata": {}
					...
					assertErr: require.Error,
					wantPaths: []string{"GET /1.0/profiles/default", "GET /1.0/profiles/default?project=internal", "GET /1.0/networks?recursion=1", "POST /1.0/networks?target=server01", "POST /1.0/networks?target=server01", "POST /1.0/networks", "POST /1.0/networks", "GET /1.0/networks/meshbr0?target=server01"},
				},
				{
  ...
  "metadata": {
    "config": {}
					...
					assertErr: require.Error,
					wantPaths: []string{"GET /1.0/profiles/default", "GET /1.0/profiles/default?project=internal", "GET /1.0/networks?recursion=1", "POST /1.0/networks?target=server01", "POST /1.0/networks?target=server01", "POST /1.0/networks", "POST /1.0/networks", "GET /1.0/networks/meshbr0?target=server01", "PUT /1.0/networks/meshbr0?target=server01"},
				},
				{
					name: "error - UpdateProfile default project - unexpected status code",
					response: []queue.Item[response]{
