...
// the architecture is known, the boot loader is installed and the external tools
// the generation shells out to are available.
func (m *Media) CheckSupported(_ context.Context, architecture images.UpdateFileArchitecture) error {
