...
func ToExprUpdate(u Update) ExprUpdate {
	return ExprUpdate{ID: u.ID, UUID: u.UUID, Format: u.Format, Origin: u.Origin, Version: u.Version, PublishedAt: u.PublishedAt, Severity: u.Severity, Channels: u.Channels, Changelog: u.Changelog, Files: u.Files, URL: u.URL, Status: u.Status, LastUpdated: u.LastUpdated}
}
