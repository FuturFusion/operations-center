...
type ExprApiClusterUpdateInProgressStatus struct {
	InProgress        bool      `json:"in_progress" yaml:"in_progress" expr:"in_progress"`
	TargetVersion     string    `json:"target_version" yaml:"target_version" expr:"target_version"`
	StatusDescription *string   `json:"status_description.omitempty" yaml:"status_description" expr:"status_description.omitempty"`
