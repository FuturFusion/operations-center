...
func ToExprCluster(c Cluster) ExprCluster {
	return ExprCluster{ID: c.ID, Name: c.Name, ConnectionURL: c.ConnectionURL, Certificate: c.Certificate, Status: c.Status, ServerNames: c.ServerNames, ServerType: c.ServerType, ServicesConfig: c.ServicesConfig, ApplicationSeedConfig: c.ApplicationSeedConfig, LastUpdated: c.LastUpdated}
}
