...
func (c *cmdNetworkIntegrationList) validateArgsAndFlags(cmd *cobra.Command, args []string) error {
	// Quick checks.
...
func (c *cmdNetworkIntegrationShow) validateArgsAndFlags(cmd *cobra.Command, args []string) error {
	// Quick checks.
...
func (c *cmdNetworkIntegrationShow) run(cmd *cobra.Command, args []string) error {
	...
	case "json":
		...
		enc.SetIndent("", "  ")
		err = enc.Encode(networkIntegration)
		if err != nil {
			return err
		}
