...
//	Force sync all
//
//	Force sync of profiles for all servers in all clusters.
//
//	---
//	produces:
//	  - application/json
...
//	  "500":
//	    $ref: "#/responses/InternalServerError"
func (i *profileHandler) forceSyncPost(r *http.Request) response.Response {
	err := i.service.SyncAll(r.Context())
	if err != nil {
		return response.SmartError(fmt.Errorf("Failed to sync profiles: %w", err))
	}
