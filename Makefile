...
update-openfga:
	@printf 'package openfga\n\n// Code generated by Makefile; DO NOT EDIT.\n\nvar authModel = `%s`\n' '$(shell $(GO) run github.com/openfga/cli/cmd/fga model transform --file=./internal/security/authz/openfga/operations-center_model.openfga | jq -c)' > ./internal/security/authz/openfga/operations-center_model.go
