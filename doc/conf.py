...
author = "Operations Center contributors"
...
html_context = {
    "github_url": "https://github.com/futurfusion/operations-center",
    "github_version": "main",
    "github_folder": "/doc/",
    "github_filetype": "md",
}
...
exclude_patterns = ["html", "README.md", ".sphinx", "config_options_cheat_sheet.md", "reference/settings_log_components.md", "development/server-deployment-states.md"]

# Open Graph configuration

ogp_site_url = "https:/docs.futurfusion.io/operations-center/main/"
ogp_site_name = "Operations Center documentation"
